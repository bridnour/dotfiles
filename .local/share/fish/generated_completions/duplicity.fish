...
complete -c duplicity -l b2-hide-files --description 'Causes Duplicity to hide files in B2 instead of deleting them.'
...
complete -c duplicity -l do-not-restore-ownership --description 'Ignores the uid/gid from the archive and keeps the current user\'s one.'
...
complete -c duplicity -l s3-region-name --description 'Specifies the region of the S3 storage.'
complete -c duplicity -l s3-endpoint-url --description 'Specifies the endpoint URL of the S3 storage.'
